...
insert into project(client_id, name, starte_date, finish_date)
values
(select id from client where name='Ivan Petrov','PROJECT_1','2023-02-01','2030-08-01'),
(select id from client where name='Oksana Ivanenko','PROJECT_2','2023-12-15','2027-03-15'),
(select id from client where name='Andrii Kovalenko','PROJECT_3','2023-08-01','2030-10-01'),
(select id from client where name='Kateryna Mykhailiuk','PROJECT_4','2023-05-15','2029-08-15'),
(select id from client where name='Bohdan Lysak','PROJECT_5','2023-09-01','2030-10-01'),
(select id from client where name='Ivan Petrov','PROJECT_6','2023-11-01','2027-03-15'),
(select id from client where name='Oksana Ivanenko','PROJECT_7','2023-10-15','2027-03-15'),
(select id from client where name='Andrii Kovalenko','PROJECT_8','2023-03-01','2030-05-01'),
(select id from client where name='Kateryna Mykhailiuk','PROJECT_9','2023-04-15','2027-03-15'),
(select id from client where name='Bohdan Lysak','PROJECT_10','2023-11-15','2029-08-15');
